...
(0, typeorm_1.createConnection)().then(function (db) {
    ...
    amqp.connect('amqps://wmqmekbr:RCf9DHx6XLA0lpx7gk1T8OOT1x7Ax0eo@bonobo.rmq.cloudamqp.com/wmqmekbr', function (error0, connection) {
        ...
        connection.createChannel(function (error1, channel) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, authRepository.findOne({ email: email })];
                        case 1:
                            user = _b.sent();
                            if (!user) {
                                alert("User doesn't exists");
                                return [2 /*return*/, res.json({ message: "User doesn't exists" })];
                                //window.alert("Error")
                                ...
                                if (password !== user.password) {
                                    ...
                                    return [2 /*return*/, res.json({ message: "User exists" })];
                                }
                            }
                            return [2 /*return*/];
                    }
            ...
            app.post('/api/registernew', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var _a, email, password, name, userExists, newadmin, result;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                        ...
                        case 2: return [4 /*yield*/, authRepository.create(req.body)];
                        case 3:
                            newadmin = _b.sent();
                            return [4 /*yield*/, authRepository.save(newadmin)];
                        case 4:
                            result = _b.sent();
